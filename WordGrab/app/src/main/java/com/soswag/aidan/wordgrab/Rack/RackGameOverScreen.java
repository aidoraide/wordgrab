...
/**
 * Created by Aidan on 2017-01-03.
 */

public class RackGameOverScreen implements GameOverScreen {
    ...
    public RackGameOverScreen(v2Tile [] tiles, String solution, int thisGamePoints, ArrayList<Word> wordsPlayed, int width, int height, int tileSize, Context context, Resources resources){

        this.context = context;
        StatsDatabase.getInstance(context).insertDataToRack(thisGamePoints, wordsPlayed);
        StatsDatabase.GameData bestGameData = StatsDatabase.getInstance(context).getBestRackGame();
